  ...
  return (
    ...
    >
      <div className="container">
        <div className="title">
          <h1 className="text-center display-6 fw-bold blue-color">
            CONTACT SECTION
          </h1>

          <div className="star-container mt-3 mb-3 d-flex justify-content-center align-items-center">
            <div id="line"></div>
            <i className="fa fa-solid fa-star blue-color"></i>
            <div id="line"></div>
          </div>
        </div>
        ...
        <div className="w-50 mx-auto">
          ...
          <button className="btn btn-outline-success px-5">Send Message</button>
        </div>
      </div>
    </section>
  );
